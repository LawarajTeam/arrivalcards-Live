...
try {
    ...
    if ($existing) {
        echo "<p class='error'>❌ North Korea already exists in database (ID: {$existing['id']}, Code: {$existing['country_code']})</p>";
    ...
    $translations = [
        'en' => [
            ...
            'duration' => '7-21 days (based on tour)',
            'passport' => '6 months validity, 2 blank pages, no Israeli stamps',
            'fee' => '$50-80 USD + $1,000-3,000+ tour package',
            'processing' => '6-8 weeks minimum',
            'url' => 'koryogroup.com or ypt.com (tour operators)',
            'arrival_card' => 'YES - Mandatory',
        ...
        'es' => [
            ...
            'duration' => '7-21 días',
            'passport' => '6 meses validez, 2 páginas',
            'fee' => '$50-80 USD + $1,000-3,000+',
            'processing' => '6-8 semanas',
            'url' => 'koryogroup.com, ypt.com',
            'arrival_card' => 'SÍ',
        ...
        'fr' => [
            ...
            'duration' => '7-21 jours',
            'passport' => '6 mois validité, 2 pages',
            'fee' => '$50-80 + $1,000-3,000+',
            'processing' => '6-8 semaines',
            'url' => 'koryogroup.com, ypt.com',
            'arrival_card' => 'OUI',
        ...
        'de' => [
            ...
            'duration' => '7-21 Tage',
            'passport' => '6 Monate gültig, 2 Seiten',
            'fee' => '$50-80 + $1,000-3,000+',
        ...
        'it' => [
            ...
            'duration' => '7-21 giorni',
            'passport' => '6 mesi validità, 2 pagine',
            'fee' => '$50-80 + $1,000-3,000+',
            'processing' => '6-8 settimane',
            'url' => 'koryogroup.com, ypt.com',
            'arrival_card' => 'SÌ',
        ...
        'ar' => [
            ...
            'duration' => '7-21 يومًا',
            'passport' => '6 أشهر، صفحتان',
            'fee' => '$50-80 + $1,000-3,000+',
            'processing' => '6-8 أسابيع',
            'url' => 'koryogroup.com, ypt.com',
            'arrival_card' => 'نعم',
    ...
    echo "<li>Country Code: <strong>PRK (🇰🇵)</strong></li>";
