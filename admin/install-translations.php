...
function getTranslations() {
    return [
        ...
        ['en', 'cp_howto_intro', 'Compare visa requirements between any two passports in just a few steps.', 'compare'],
        ['en', 'cp_howto_step1_title', 'Select First Passport', 'compare'],
        ['en', 'cp_howto_step1_text', 'Choose your first passport from the dropdown menu below.', 'compare'],
        ['en', 'cp_howto_step2_title', 'Select Second Passport', 'compare'],
        ['en', 'cp_howto_step2_text', 'Choose a second passport to compare against the first.', 'compare'],
        ['en', 'cp_howto_step3_title', 'View Results', 'compare'],
        ['en', 'cp_howto_step3_text', 'Click Compare to see detailed side-by-side visa requirements for every destination.', 'compare'],
        ['en', 'cp_howto_tip_label', 'Tip:', 'compare'],
        ['en', 'cp_howto_tip_text', 'You can compare any two passports that have bilateral visa data in our database.', 'compare'],
