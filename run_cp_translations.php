<?php
/**
 * Run Compare Passports Translations
 * Execute via browser: https://arrivalcards.com/run_cp_translations.php?key=CPtrans2025!
 */

if (!isset($_GET['key']) || $_GET['key'] !== 'CPtrans2025!') {
    die('Unauthorized');
}

require_once __DIR__ . '/includes/config.php';

echo "<h2>Running Compare Passports Translations...</h2><pre>";

$sqlFile = __DIR__ . '/add_compare_passports_translations.sql';
...
echo "\nTotal compare_passports translations: $total\n";
echo "</pre>";
