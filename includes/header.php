    ...
    <header class="site-header">
        <div class="container">
            <div class="header-content">
                ...
                <a href="<?php echo APP_URL; ?>/request-callback.php" class="btn-header-agent" aria-label="Talk to a visa agent">
                    ...
                    <span class="btn-header-agent-label">Talk to Agent</span>
                </a>
                <?php endif; ?>
